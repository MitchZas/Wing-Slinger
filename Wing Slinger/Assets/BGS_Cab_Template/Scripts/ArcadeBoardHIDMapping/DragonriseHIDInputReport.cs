...
struct DragonriseHIDInputReport : IInputStateTypeInfo
{
    ...
    [InputControl(name = "buttonSouth", displayName = "BottomRow1", bit = 4)]
    [InputControl(name = "buttonEast", displayName = "BottomRow2", bit = 5)]
    [InputControl(name = "buttonWest", displayName = "TopRow1", bit = 6)]
    [InputControl(name = "buttonNorth", displayName = "TopRow2", bit = 7)]
    [InputControl(name = "leftShoulder", displayName = "TopRow3", bit = 11)]
    ...
    //[InputControl(name = "leftShoulder", displayName = "TopRow3", offset = 0, bit= 10, defaultState = 0)]
    [InputControl(name = "rightShoulder", displayName = "BottomRow3", bit = 5)]
    [InputControl(name = "leftShoulder", displayName = "TopRow3", bit= 6)]
    ...
    [InputControl(name = "select", displayName = "CoinSlot", bit = 0)]
    [InputControl(name = "start", displayName = "PlayerButton", bit = 2)]
